...
echo('You cant exchange this amount.');
footer();
die();
}else{
$newrobux = $robuxamount - $amount;
$newtix = $tixamount + $amount;
...
$query->execute([':newr' => $newtix, ':uid' => $uid]);
...
<head>
    ...
    <title>Xscape - Currency Exchange</title>
...
<div class="security-container secruity-password-container">
    <div class="section-content"><form method="post" action="">
        <div><h1>Currency Exchange</h1>
          ...
          <option value="robux">Robux to Tickets</option>
          <option value="tix">Tickets to Robux</option>
          </select>
          </div>
                        <div class="form-group">
                            <input name="amount" type="text" class="form-control input-field" placeholder="Amount to convert"/>
                        </div>
                        <div class="form-group">
                            <span>Current Rate: 1 Robux = 1 Tix</span>
                        </div>
