...
$query = $db->prepare("SELECT * FROM games WHERE id = :gameid");
$query->execute([':gameid' => $_GET['id']]);

$game = $query->fetch();

$query1 = $db->prepare("SELECT * FROM accounts WHERE id = :Cid");
$query1->execute([':Cid' => $game['creatorid']]);

$creator = $query1->fetch();
...
$query3 = $db->prepare("SELECT * FROM visits WHERE game = :id");
$query3->execute([':id' => $_GET['id']]);

$getVisits = $query3->fetch();
...
$cleanname = $ep->remove($game['name']);
$cleandesc = $ep->remove($game['description']);
}
}else{
die('<META http-equiv=refresh content=0;URL=/home>');
exit;
...
<head>
    ...
    <!-- MachineID: WEB406 -->
    <title><?=$cleanname?> - Xscape</title>
	<link rel="canonical" href="http://xsscape.cf" />
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="author" content="<?=$cleanname?> - Xscape"/>
    ...
    <link href="favicon.ico" rel="icon"/>
     ...
     <link rel="stylesheet" href="https://xsscape.cf/content/css/games.css"/>
...
<span><img class="carousel-thumb" width="640" height="340" src="<?=$game['thumbnail']?>"/></span>            </div>
    </div>
    ...
    <a class="right carousel-control" href="#carousel-game-details" role="button" data-slide="next">
        ...
        <div class="game-calls-to-action">
            <div class="game-title-container">
                <h2 class="game-name" title="<?=$cleanname?>"><?=$cleanname?></h2>
                <div class="game-creator"><span class="text-label">By</span> <a class="text-name" href="User.aspx?ID=<?=$game['creatorid']?>"><?=$creatorName?></a></div>
            </div>
            <div class="game-play-buttons" data-autoplay="false">
                            <div id="MultiplayerVisitButton" class="VisitButton VisitButtonPlayGLI" placeid="2" data-action="play" data-is-membership-level-ok="true">
                                <a href="/api/NewJoin.php?Game=<?=$game['id']?>" class="btn-primary-lg">Play</a>
                            </div>
    ...
    $(function() {
        ...
        <li class="favorite-button-container tooltip-container" data-toggle="tooltip" title="" data-original-title="Add to Favorites">
            <a>
                ...
                <span title="0" class="text-favorite favoriteCount <?=$game['favs']?>" id="result"><?=$game['favs']?></span>
            </a>
        </li>
        <li class="voting-panel body" data-asset-id="189707" data-total-up-votes="<?=$game['likes']?>" data-total-down-votes="<?=$game['dislikes']?>" data-vote-modal="" data-user-authenticated="true">
                    ...
                    <div class="voting-details">
                        <div class="users-vote ">
                            <div class="upvote">
                                ...
                                <span id="vote-up-text" title="<?=$game['likes']?>" class="vote-text"><?=$game['likes']?></span>
                            </div>
                            <div class="downvote">
                                <span id="vote-down-text" title="<?=$game['dislikes']?>" class="vote-text"><?=$game['dislikes']?></span>
            ...
            <div class="tab-pane active" id="about">
                <div class="section game-about-container">
                    ...
                    <div class="section-content">
                        <p class="game-description linkify"><?=$cleandesc?></p>
                        <ul class="game-stats-container">
                            <li class="game-stat">
                                <p class="text-label">Visits</p>
                                <p class="text-lead"><?=$visits?></p>
                            </li>
                            <li class="game-stat">
                                <p class="text-label">Created</p>
                                <p class="text-lead"><?=$game['created']?></p>
                            </li>
                            <li class="game-stat">
                                <p class="text-label">Playing</p>
                                <p class="text-lead"><?=$players?></p>
                            </li>
                            <li class="game-stat">
                            ...
                            <li class="game-stat">
                                ...
                                <p class="text-lead stat-gears">
                                    <?php if($game['gearAllowed'] == 0){ ?><span class="icon-nogear" data-toggle="tooltip" data-original-title="No Gear Allowed"></span><?php }else{ echo('
    <span class="icon-partialgears" data-toggle="tooltip" data-original-title="All Genres Gear Only"></span>
    <span data-toggle="tooltip" data-original-title="Melee" class="icon-MeleeWeapon"></span>
    <span data-toggle="tooltip" data-original-title="Ranged" class="icon-RangedWeapon"></span>
    <span data-toggle="tooltip" data-original-title="Explosive" class="icon-Explosive"></span>
    <span data-toggle="tooltip" data-original-title="Power Up" class="icon-PowerUp"></span>
    <span data-toggle="tooltip" data-original-title="Navigation" class="icon-NavigationEnhancer"></span>
    <span data-toggle="tooltip" data-original-title="Musical" class="icon-MusicalInstrument"></span>
    <span data-toggle="tooltip" data-original-title="Social" class="icon-SocialItem"></span>
    <span data-toggle="tooltip" data-original-title="Building" class="icon-BuildingTool"></span>
    <span data-toggle="tooltip" data-original-title="Transport" class="icon-PersonalTransport"></span>'); } ?>
                                </p>
                            </li>
                        </ul>
        ...
        <ul class="badge-list">
                <li class="section-row badge-row ">
                    <div class="badge-image">
                        <a href=""><img src="https://tr.rbxcdn.com/b19213cc61aee5422ca7be78207a5de3/420/420/Image/Png" alt="Test Badge 1"></a>
                    </div>
                    <div class="badge-content">
                        <div class="badge-data-container">
                            <div class="badge-name">Test Badge 1</div>
                            <p class="para-overflow">
                                A test badge you will never obtain.
                            </p>
                        </div>
                        <ul class="badge-stats-container">
                            ...
                            <li>
                                ...
                                <div class="badge-stats-info">0</div>
                            </li>
                            <li>
                ...
                <li class="section-row badge-row ">
                    <div class="badge-image">
                        <a href=""><img src="https://tr.rbxcdn.com/b19213cc61aee5422ca7be78207a5de3/420/420/Image/Png" alt="Test Badge 2"></a>
                    </div>
                    <div class="badge-content">
                        <div class="badge-data-container">
                            <div class="badge-name">Test Badge 2</div>
                            <p class="para-overflow">
                                Another test badge you will never obtain.
                            </p>
                        </div>
                        <ul class="badge-stats-container">
                            <li>
                ...
                <li class="section-row badge-row ">
                    <div class="badge-image">
                        <a href=""><img src="https://tr.rbxcdn.com/b19213cc61aee5422ca7be78207a5de3/420/420/Image/Png" alt="Test Badge 3"></a>
                    </div>
                    <div class="badge-content">
                        <div class="badge-data-container">
                            <div class="badge-name">Test Badge 3</div>
                            <p class="para-overflow">
...
Caution: floor slippery when wet.
            ...
            <li>
							<div class="section-content">
<span style="color:red;">These badges are just for show.</span>
</div>
            </li>
        </ul>
    </div>
...
<div id="ProtocolHandlerStartingDialog" style="display:none;">
    <div class="modalPopup ph-modal-popup">
        ...
        <div class="ph-logo-row">
            <img data-delaysrc="https://xsscape.cf/content/images/shortlogo.png" width="90" height="90" alt="R" src="https://xsscape.cf/content/images/shortlogo.png" class="src-replaced">
        </div>
    ...
    <div id="InstallationInstructions" class="" style="display:none;">
        ...
        <div class="ph-install-step ph-installinstructions-step4-of4">
            ...
            <div class="VisitButton VisitButtonContinueGLI">
                <a href="/api/NewJoin.php?Game=<?=$game['id']?>" class="btn btn-primary-lg disabled">Play</a>
            </div>
        </div>
