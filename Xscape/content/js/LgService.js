...
ValidateLogin:function(userName,password,isCaptchaOn,challenge,captchaResponse,userHostAddress,succeededCallback, failedCallback, userContext) {
return this._invoke(this._get_path(), 'ValidateLogin',false,{userName:userName,password:password,isCaptchaOn:isCaptchaOn,challenge:challenge,captchaResponse:captchaResponse,userHostAddress:userHostAddress},succeededCallback,failedCallback,userContext); }}
...
Roblox.Website.Services.Secure.LoginService.ValidateLogin= function(userName,password,isCaptchaOn,challenge,captchaResponse,userHostAddress,onSuccess,onFailed,userContext) {Roblox.Website.Services.Secure.LoginService._staticInstance.ValidateLogin(userName,password,isCaptchaOn,challenge,captchaResponse,userHostAddress,onSuccess,onFailed,userContext); }