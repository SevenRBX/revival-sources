...
if game.CoreGui.Version < 3 then return end -- peace out if we arentt using the right client
...
Backpack.Active = true
	...
	Tabs.Parent = Backpack
		...
		closeButton.Modal = true
			...
			XImage.Name = "XImage"
			game:GetService("ContentProvider"):Preload("http://2012.hereelabs.cf/asset/?id=75547445")
			XImage.Image = "http://2012.hereelabs.cf/asset/?id=75547445"  --TODO: move to rbxasset
...
------------------------------- WARDROBE -------------------------------------------------------
	if game.CoreGui.Version < 8 then
		-- no need for this to stick around, we arentt ready for wardrobe
		script:remove()
		return
	end
	...
	Wardrobe.Parent = Backpack
		...
		CharacterPane.Parent = Wardrobe
			...
			local FaceFrame = makeCharFrame("FacesFrame", CharacterPane)
				game:GetService("ContentProvider"):Preload("http://2012.hereelabs.cf/asset/?id=75460621")
				makeZone("FaceZone","http://2012.hereelabs.cf/asset/?id=75460621",UDim2.new(0,157,0,137),UDim2.new(0.5,-78,0.5,-68),FaceFrame)
			...
			local HeadFrame = makeCharFrame("HeadsFrame", CharacterPane)
				makeZone("FaceZone","http://2012.hereelabs.cf/asset/?id=75460621",UDim2.new(0,157,0,137),UDim2.new(0.5,-78,0.5,-68),HeadFrame)
			...
			local HatsFrame = makeCharFrame("HatsFrame", CharacterPane)
				game:GetService("ContentProvider"):Preload("http://2012.hereelabs.cf/asset/?id=75457888")
				local HatsZone = makeZone("HatsZone","http://2012.hereelabs.cf/asset/?id=75457888",UDim2.new(0,186,0,184),UDim2.new(0.5,-93,0.5,-100), HatsFrame)
			...
			local PantsFrame = makeCharFrame("PantsFrame", CharacterPane)
				game:GetService("ContentProvider"):Preload("http://2012.hereelabs.cf/asset/?id=75457920")
				makeZone("PantsZone","http://2012.hereelabs.cf/asset/?id=75457920",UDim2.new(0,121,0,99),UDim2.new(0.5,-60,0.5,-100),PantsFrame)
			...
			local TShirtFrame = makeCharFrame("T-ShirtsFrame",CharacterPane)
				game:GetService("ContentProvider"):Preload("http://2012.hereelabs.cf/asset/?id=75460642")
				makeZone("TShirtZone","http://2012.hereelabs.cf/asset/?id=75460642",UDim2.new(0,121,0,154),UDim2.new(0.5,-60,0.5,-100),TShirtFrame)
			...
			local ShirtFrame = makeCharFrame("ShirtsFrame", CharacterPane)
				makeZone("ShirtZone","http://2012.hereelabs.cf/asset/?id=75460642",UDim2.new(0,121,0,154),UDim2.new(0.5,-60,0.5,-100),ShirtFrame)
			...
			local ColorFrame = makeCharFrame("ColorFrame", CharacterPane)
				game:GetService("ContentProvider"):Preload("http://2012.hereelabs.cf/asset/?id=76049888")
				local ColorZone = makeZone("ColorZone","http://2012.hereelabs.cf/asset/?id=76049888", UDim2.new(0,120,0,150),UDim2.new(0.5,-60,0.5,-100),ColorFrame)
