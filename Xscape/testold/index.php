    ...
    <div class="container">
        <div class="row">
            <div class="navbar-header col-md-6">
                ...
                <div class="navbar-brand hidden-xs"><img alt="Roblox Logo" class="robloxLogo" src="https://dtjatwg9u87ct.cloudfront.net/content/images/shortlogo.png"/></div>
...
<div class="collapse navbar-collapse col-sm-6" id="LandingNavbar" ng-modules="roblox.formEvents">
    <form name="loginForm" action="newlogin.html" id="LogInForm" class="navbar-form form-inline navbar-right" method="post" role="form" rbx-form-context context="RollerCoaster" novalidate>
        ...
        <a id="HeaderForgotPassword" class="navbar-link" href="Login/ResetPasswordRequest.html">Forgot Username/Password?</a>
...
<img src="" style="position: absolute"/>
            ...
            <div class="legal-text-container">
                By signing up you agree to our <a href="" target="_blank">Terms</a> and <a href="" target="_blank">Privacy Policy</a> 
            </div>
            <button id="signup-button" type="button" tabindex="9" class="btn-primary-md signup-submit-button" rbx-form-interaction name="signupSubmit" ng-disabled="isSubmitting" data-signup-api-url="" ng-click="submitSignup($event)" ng-keypress="submitSignup($event)">Sign Up</button>
            <noscript>
    ...
    <div class="captcha-container" ng-controller="CaptchaController" ng-form name="captchaForm" rbx-form-context context="RollerCoaster" ng-cloak ng-show="isSectionShown">
        ...
        <div class="attribution hidden-xs">
            ...
            Developer: <span class="notranslate">-Seven-#4495</span>
        </div>
    </section>
...
<span class="footer-kid-safe-logo">
    <a href="https://www.kidsafeseal.com/certifiedproducts/roblox.html" target="_blank"><img border="0" alt="Roblox.com (under-13 user experience) is certified by the kidSAFE Seal Program." src=""></a>
</span>        </p>
    </div>
</footer>
